...
public class ClientServiceImpl implements ClientService {
    ...
    public void editClient(ClientDTO clientDTO) throws NoMatchException {
        Optional<Client> existingClient = getExistingClientById(clientDTO.getId());

        Client updatedClient = updateClient(existingClient.get(), clientDTO);
    ...
    public void deleteClient(Long id) throws NoMatchException {
        Optional<Client> existingClient = getExistingClientById(id);
    ...
    private Client updateClient(Client existingClient, ClientDTO clientDTO) {
        ...
        existingClient.setConsultantsAssigned(clientDTO.getConsultantsAssigned());
        ...
        existingClient.setMainTechnologies(clientDTO.getMainTechnologies());
        return existingClient;
    }

    private Optional<Client> getExistingClientById(Long id) throws NoMatchException {
