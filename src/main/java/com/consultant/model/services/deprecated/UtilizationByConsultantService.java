...
public class UtilizationByConsultantService {
    ...
    @Autowired
    public UtilizationByConsultantService(UtilizationRepository utilizationRepository, ConsultantService consultantService) {
    ...
    public void reCalcAllUtil() {
        ...
        while (!firstDayOfCalculatingMonth.isAfter(LocalDate.now())) {
