...
//    @Test
//    public void returnUtilizationForPartialAidedConsultantWithActiveContract2() {
//        Contract contract = new Contract();
//        consultantDTO.setDateJoined((LocalDate.of(2019,12,3)));
//        consultantDTO.setDeleted(false);
//        consultantDTOS.add(consultantDTO);
//        initializeContract(contract, LocalDate.of(2020,3,9), consultantDTO);
//
//        Assert.assertEquals(83.87, utilizationService.calculateAidedUtilizationPercentageOfGivenMonth((LocalDate.of(2020,4,1))), 0.01);
//    }
//
    @Test
